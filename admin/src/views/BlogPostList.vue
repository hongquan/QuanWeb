<template>
  <div>
    <div class='mb-3 sm:flex justify-end'>
      <RouterLink
        to='/posts/new'
        class='block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm py-1.5 px-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'
      >
        New post
      </RouterLink>
    </div>
